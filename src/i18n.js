...
(function () {
  const FA = {
    ...
    'Columns': 'ستون‌ها',
    'Insert': 'درج',
    'A table needs at least one column': 'یک جدول باید دست‌کم یک ستون داشته باشد',
    ...
    'Attach file': 'پیوست فایل',
    'Type a note… Enter saves': 'یادداشت… با Enter ذخیره می‌شود',
    'Save (Enter)': 'ذخیره (Enter)',
    'Message the AI… Enter sends': 'پیام به هوش مصنوعی… Enter می‌فرستد',
